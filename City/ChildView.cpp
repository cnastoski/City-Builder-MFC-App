...
BEGIN_MESSAGE_MAP(CChildView, CWnd)
	...
	ON_COMMAND(ID_FILE_FIXROADS, &CChildView::OnFileFixroads)
...
/**
 * calls a visitor function to all roads so that 
 * they can fix their configuration
 */
void CChildView::OnFileFixroads()
{
	
	CRoadFixVisitor visitor;
	mCity.Accept(&visitor);
...
/**
 * sets the check mark on the menu
 * \param pCmdUI sets the check mark on the menu
 */
